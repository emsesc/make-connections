...
import {
  APP_DATE,
  MODERN_LOVE_ARTICLE_BODY,
  MODERN_LOVE_ARTICLE_TITLE,
  MODERN_LOVE_AUTHOR,
  MODERN_LOVE_IMAGE_ALT,
  MODERN_LOVE_IMAGE_CAPTION,
  MODERN_LOVE_IMAGE_SRC,
  MODERN_LOVE_TITLE,
} from '../constants';

const MODERN_LOVE_SECTION_LABEL = 'MODERN LOVE';
const MODERN_LOVE_SUBTITLE =
  'Modern Love in miniature, featuring reader-submitted stories of no more than 100 words. (This one is longer.)';

export const ModernLovePage = () => {
  return (
    <Box w="100vw" minH="100vh" bg="white" color="black">
      ...
      <Flex maxW="600px" mx="auto" w="100%" align="flex-start" justify="flex-start" pt={6} borderBottomWidth={1} borderColor="gray.200" pb={6}>
        <Stack spacing={2}>
          <Text fontSize="12px" fontWeight="bold" letterSpacing="1px">
            {MODERN_LOVE_SECTION_LABEL}
          </Text>
      ...
      <Flex maxW="600px" mx="auto" w="100%" align="flex-start" justify="flex-start" pt={10}>
        <Stack spacing={4}>
          ...
          <Image src={MODERN_LOVE_IMAGE_SRC} alt={MODERN_LOVE_IMAGE_ALT} />
